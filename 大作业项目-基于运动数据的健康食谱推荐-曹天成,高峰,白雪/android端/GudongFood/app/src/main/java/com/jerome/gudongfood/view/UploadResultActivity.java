...
//                startActivity(intent);
    ...
    private void doUpload() {
        StringRequest stringRequest = new StringRequest("http://10.0.2.2:8080/SportsRecipe/sport_upload?username=gaofeng&length=3600&caloria=500&bupin=60&bufu=80&steps=3000&avgspeed=5",
