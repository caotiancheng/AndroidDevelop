...
//        User.portrait=User.bitmapToString(b);
    ...
    private void updateInfo() {
        StringRequest stringRequest1 = new StringRequest("http://10.0.2.2:8080/SportsRecipe/user_update?" +
        ...
        StringRequest stringRequest2 = new StringRequest("http://10.0.2.2:8080/SportsRecipe/img_update?" +
...
//        pTask.execute((Void) null);
    ...
    public class GetProfileTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            StringRequest stringRequest1 = new StringRequest("http://10.0.2.2:8080/SportsRecipe/user_inf?username=" + UserDataUtil.currentUser,
                    new Response.Listener<String>() {
                        public void onResponse(String s) {
                            Gson gson = new Gson();
